...
public class SAQAProfile {
	...
	private final Logger log = Logger.getLogger(SAQAProfile.class.getName());
	...
	public void setup() throws Exception {
		...
		merchantSheet = wrkBook1.getSheet("SAQA");
			...
			for (int scenario = 1; scenario <= pRowCount;) {
				...
				if (currentScenario != null) {
					...
					if (merchanRowNum <= count) {
						...
						for (int screenNumber = 1; screenNumber < prow
						...
						Thread.sleep(Integer.parseInt(clientProps
								.getProperty("delay.waitsecond.timeunits.seconds")));
						// saqType=driver.findElement(By.cssSelector(clientProps.getProperty("dashboard.saqtype.text.css"))).getText();
